...
public class EventReportActivity extends AppCompatActivity {
    ...
    private Uri mImgUri;    // local file reference
    //Set variables ready for authentication
    private FirebaseAuth mAuth;
    private FirebaseAuth.AuthStateListener mAuthListener;
    //Set variables ready for location tracker
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // deal with location related network request (avoid occupy async class)
        mLocationTracker = new LocationTracker(this);
        mLocationTracker.getLocation();
        mImageLocation = (ImageView) findViewById(R.id.img_event_location);
        // Add click listener to show/hide current address
        mImageLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (showLocation) {
                    // private class newClass extends AsyncTask<Void, Void, Void>{}
        ...
        mImageViewCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(intent, RESULT_LOAD_IMAGE);  // trigger onActivityResult()
            }
        });
